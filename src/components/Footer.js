          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="text-gray-300 text-base flex flex-col">
              <div className="flex">
                ...
                <p className="text-gray-300 text-md ml-4">{blok.address}</p>
              </div>
              <div className="flex">
                <FaPhoneAlt className="text-2xl text-primarybg" />
                <p className="text-gray-300 text-md ml-4">{blok.phone}</p>
              </div>
              <div className="flex">
                <GrMail className="text-2xl text-primarybg" />
                <p className="text-gray-300 text-md ml-4">{blok.email}</p>
              </div>
              <div className="flex">
                <FaClock className="text-2xl text-primarybg" />
                <p className="text-gray-300 text-md ml-4">{blok.timeline}</p>
              </div>
            </div>
